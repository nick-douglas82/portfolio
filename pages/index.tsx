...
const Home = ({ projects, skills }: InferGetStaticPropsType<typeof getStaticProps>) => {
  return (
    <div className="font-Poppins font-medium h-full relative">
      ...
      <nav className="w-full absolute top-0 left-0 px-4 py-2 lg:p-2 flex justify-between">
        <h1 className='text-2xl md:text-4xl lg:text-2xl font-semibold tracking-tighter'>Nick Douglas<span className="text-orange-500">.</span></h1>

        <ul className="flex gap-3 fixed top-2 right-4 lg:right-2">
      ...
      <main className="container px-4 h-full">
        <header className="h-screen flex justify-center flex-col">
          ...
          <h3 className="text-xl md:text-2xl font-light text-gray-700 leading-snug w-full md:w-3/4">Senior Freelance Frontend Developer<span className="text-orange-500">.</span> Currently I am work as a Senior Frontend Engineer at&nbsp;
        ...
        <section className="-mt-16 pb-16">
          <h2 className="text-4xl md:text-6xl leading-none">Skills<span className="text-orange-500">.</span></h2>
          <h4 className="text-lg md:text-xl font-light text-gray-700 mb-10">Things I know<span className="text-orange-500">.</span></h4>
        ...
        <section className="pb-16 lg:pb-36">
          <h2 className="text-4xl md:text-6xl leading-tight lg:mb-1">Projects<span className="text-orange-500">.</span></h2>
          <h4 className="text-lg md:text-xl font-light text-gray-700 mb-10">Things I&apos;ve worked on<span className="text-orange-500">.</span></h4>
